...
description: Bootstrap DDD 4-layer domain structure. Creates repositories, api-clients, hooks, and components directories with __tests__ and index.ts exports. Used by agents during v0.1.x PROJECT phase.
---
